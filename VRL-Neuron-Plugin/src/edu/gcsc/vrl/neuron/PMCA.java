 ...
 * @author stephangrein
 */
@ComponentInfo(name="PMCA", category="NeuronPlugin/Pumps/AZ", description="creates channels from ion type selection")
public class PMCA implements IChannel, Serializable {
