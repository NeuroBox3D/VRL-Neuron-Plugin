 ...
 * @author stephangrein
 */
@ComponentInfo(name="AMPA", category="NeuronPlugin/Channels/PSD", description="creates channels from ion type selection")
public class AMPA implements IChannel, Serializable {
