 ...
 * @author stephangrein
 */
@ComponentInfo(name="NMDA", category="NeuronPlugin/Channels/PSD", description="creates channels from ion type selection")
public class NMDA implements IChannel, Serializable {
	...
	public void init() {
         ...
         */
        @Override
        public void advance(@ParamInfo(name="timestep", style="slider", options="min=0; max=10000; invokeOnChange=true; value=0") double dt) {
        }
