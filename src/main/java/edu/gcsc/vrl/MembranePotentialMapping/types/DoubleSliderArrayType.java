 ...
 * @author stephan
 */
@TypeInfo(type = Double.class, input = true, output = false, style = "slider-array")
public class DoubleSliderArrayType extends ArrayBaseType {

	private static final long serialVersionUID = 1L;

	public DoubleSliderArrayType() {
		setValueName("Double Slider Array:");
